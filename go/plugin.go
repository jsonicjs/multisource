...
// references resolve plainly — matching the TypeScript mem resolvefolder. A
// path that contains separators yields everything up to the last one (its
// containing directory), matching the TypeScript file/pkg resolvefolder for a
// loaded file.
